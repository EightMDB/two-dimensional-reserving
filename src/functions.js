// Core business logic and utility functions for Two-Dimensional Reserving
...
function initializeEventListeners() {
    // document.getElementById('generate-triangle').addEventListener('click', generateClaimsTriangle); // Moved to triangle-methodology.js
    ...
    document.getElementById('load-configuration').addEventListener('change', loadConfigurationFile);
    document.getElementById('download-configuration').addEventListener('click', downloadConfiguration);
    document.getElementById('apply-configuration').addEventListener('click', applyConfigurationPreset);
    document.getElementById('reset-configuration').addEventListener('click', resetToDefaultConfiguration);

    // Factor method changes
    document.getElementById('factor-method').addEventListener('change', handleFactorMethodChange);
    document.getElementById('factor-override').addEventListener('change', handleFactorOverrideToggle);
    ...
    document.getElementById('export-comparison').addEventListener('click', exportMethodComparison);
    ...
    // document.getElementById('toggle-view').addEventListener('click', toggleTriangleView); // Moved to triangle-methodology.js
...
function initializeUploadArea() {
    // Use global cached DOM elements from main.js instead of querying again
    const uploadAreaElement = uploadArea || document.getElementById('upload-area');
    const browseFileBtnElement = browseFileBtn || document.getElementById('browse-file');
    const csvFileInputElement = csvFileInput || document.getElementById('csv-file');
    ...
    // File browse button
    browseFileBtnElement.addEventListener('click', () => {
    ...
    // File input change
    csvFileInputElement.addEventListener('change', handleFileSelect);
...
// Triangle Generation - Functions moved to triangle-methodology.js

// Analysis Functions - Moved to triangle-methodology.js
...
// getFactorMethodDescription function moved to triangle-methodology.js
...
// Method Comparison & Sanity Checks - Functions moved to triangle-methodology.js
...
// Triangle view toggling moved to triangle-methodology.js
...
function exportMethodComparison() {
    // const methodComparison = generateMethodComparisonData(); // Function moved to triangle-methodology.js
...
function generateAuditData() {
    ...
    return {
        ...
        calculations: {
            ...
            methodComparison: {} // generateMethodComparisonData() moved to triangle-methodology.js
        },
        auditTrail: {
...
function generateIntermediateTriangles() {
    ...
    // const incremental = buildIncrementalTriangle(claimsData); // Function moved to triangle-methodology.js
...
// generateMethodComparisonData function moved to triangle-methodology.js
function generateMethodComparisonData() {
    // This function has been moved to triangle-methodology.js
    console.warn('generateMethodComparisonData has been moved to triangle-methodology.js');
    return {};
}
